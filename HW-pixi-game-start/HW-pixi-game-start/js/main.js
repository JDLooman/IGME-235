...
function setup() {
	...
	// #7 - Load sprite sheet// #7 - Load sprite sheet
...
function end(){
    ...
    let playerScore = new PIXI.Text(`Your Final Score: ${gameOverScoreLabel}`);
    playerScore.style = new PIXI.TextStyle({
        fill: 0xFFFFFF,
        fontSize: 32,
        fontFamily: "Futura",
        stroke: 0xFF0000,
    ...
    playerScore.x = 150;
    playerScore.y = sceneHeight / 2 + 50;
    gameOverScene.addChild(playerScore);
}
